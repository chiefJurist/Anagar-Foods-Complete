<template>
    <div class=" px-6 grid grid-cols-2 lg:grid-cols-5 gap-5 bg-bg-7 mt-40">
        <div>
            <img src="/img/food-okpa.jpg" alt="" class=" w-60 rounded-lg lg:w-72 transition duration-2000 ease-out" v-motion-pop-visible>
        </div>
        ...
        <div>
            <img src="/img/img-4.jpg" alt="" class=" w-60 rounded-lg lg:w-80 lg:h-72 transition duration-1500 ease-out" v-motion-pop-visible>
        </div>
        ...
        <div>
            <img src="/img/img-6.jpg" alt="" class=" w-60 rounded-lg lg:w-72 transition duration-1500 ease-out" v-motion-pop-visible>
        </div>

        <div>
            <img src="/img/img-8.jpg" alt="" class=" w-60 rounded-lg lg:w-72 transition duration-1500 ease-out" v-motion-pop-visible>
        </div>
        ...
        <div>
            <img src="/img/img-9.jpg" alt="" class=" w-60 rounded-lg lg:w-72 transition duration-1500 ease-out" v-motion-pop-visible>
        </div>
    </div>
</template>